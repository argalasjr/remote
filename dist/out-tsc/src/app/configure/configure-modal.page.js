 ...
 */
var ConfigureModalPage = /** @class */ (function () {
    function ConfigureModalPage(modalCtrl, alertCtrl, tr, bleService, platform, cd, helpers) {
    ...
    ConfigureModalPage.prototype.ngOnInit = function () {
    ...
    ConfigureModalPage.prototype.ionViewWillLeave = function () {
        console.log('ionViewWillLeave ConfigureModalPage');
        this.subscriptions.forEach(function (s) { return s.unsubscribe(); });
        this.disconnect();
    };
    ConfigureModalPage.prototype.connectToWifi = function () {
        var _this = this;
    ...
    ], ConfigureModalPage.prototype, "connectedDevice", void 0);
    ConfigureModalPage = __decorate([
        Component({
    ...
    return ConfigureModalPage;
}());
export { ConfigureModalPage };
//# sourceMappingURL=configure-modal.page.js.map