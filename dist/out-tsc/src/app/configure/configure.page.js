...
var ConfigurePage = /** @class */ (function () {
    function ConfigurePage(navCtrl, cd, bleService, ble, modalCtrl, platform, loadingService, remoteDevice, tr, helpers) {
    ...
    ConfigurePage.prototype.ngOnInit = function () {
    ...
    ConfigurePage.prototype.startScan = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ConfigurePage.prototype.stopScan = function () {
        this.scanning = false;
        this.ble.stopScan();
    };
    ConfigurePage.prototype.connect = function (device) {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    ConfigurePage.prototype.openModal = function (connectedDevice) {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.modalCtrl.create({ component: ConfigureModalPage, componentProps: { connectedDevice: connectedDevice } })];
                    case 1:
                        modal = _a.sent();
                        modal.present();
...
//# sourceMappingURL=configure.page.js.map