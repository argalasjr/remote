...
var ErrorDialogService = /** @class */ (function () {
    function ErrorDialogService(alertCtrl, tr) {
        this.alertCtrl = alertCtrl;
        this.tr = tr;
    }
    ErrorDialogService.prototype.showError = function (error) {
    ...
    ErrorDialogService = __decorate([
        ...
        __metadata("design:paramtypes", [AlertController, TranslateService])
    ], ErrorDialogService);
